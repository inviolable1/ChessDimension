...
|
*/
$config['log_threshold'] = 4;   //use 4 for local stack
...
$config['sess_use_database']	= FALSE;	//because we're not using CodeIgniter's database, we're using Ion Auth.
...
|
*/
$config['cookie_prefix']	= 'chessdimension_';
